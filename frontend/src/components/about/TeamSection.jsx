...
const TEAM = [
  {
    ...
    bio: "Former Lead Architect with 15 years in global logistics.",
    image:
  ...
  },
  {
    ...
    bio: "Specialist in scalable cloud infrastructure and systems design.",
    image:
  ...
  },
  {
    ...
    bio: "User experience obsessive with a background in industrial design.",
    image:
  ...
  },
  {
    ...
    bio: "Operations strategist focused on global supply chain efficiency.",
    image:
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-xl">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant">
              Guided by industry veterans with a passion for architectural
